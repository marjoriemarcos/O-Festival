...
| /boutique/produit/{id}*     | GET         | ShopController        | read      | Nom du produit                 | Item details                              | {id} is the item to display              |
| /boutique/panier*           | GET         | CartController        | browse    | Panier                         | List of items in the cart                 | -                                        |
| /boutique/panier*           | GET / POST  | CartController        | add       | Ajouter un produit au panier   | Adding an item to the cart                | -                                        |
| /boutique/panier/{id}*      | GET / POST  | CartController        | delete    | Supprimer un produit du panier | Removing an item from the cart            | {id} is the item to remove from the cart |
...
| /back/shop*                  | GET         | ShopController     | browse | Liste des Produits          | List of items                 | -                               |
| /back/shop/item/add*         | GET / POST  | ShopController     | add    | Ajouter un Produit          | Form to add an item           | -                               |
| /back/shop/item/{id}*        | GET         | ShopController     | read   | Détails du Produit          | Item details                  | {id} is the item to display     |
| /back/shop/item{id}/edit*    | GET / PATCH | ShopController     | edit   | Éditer le Produit           | Form to edit an item          | {id} is the item to edit        |
| /back/shop/item/{id}/delete* | POST        | ShopController     | delete | Supprimer le Produit        | Deleting an item              | {id} is the item to delete      |
